...
##    kernelY=GaussianKernel()
    ...
    # kernelY = GaussianKernel(float(0.05))
    # kernelX=GaussianKernel(float(0.05))
    
    
    kernelY = GaussianKernel(float(0.2))
    kernelX=GaussianKernel(float(0.2))

    # kernelY = GaussianKernel(float(0.6))
    # kernelX=GaussianKernel(float(0.6))
